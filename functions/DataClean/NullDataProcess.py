...
class NullDataClean:
    ...
    def fillna_with_mean(self, to_fill):
        ...
        :return:    DataFrame, 处理后的数据
        """ 
        self.data[to_fill].fillna(self.data[to_fill].mean(), inplace=True)
    ...
    def fillna_with_randomforest(self,to_fill:str):
        ...
        rfr_model = rfr(n_estimators=100,random_state=420)
        rfr_rst = rfr_model.fit(X_train, y_train)
        y_predict = rfr_rst.predict(X_test)
...
if __name__ == '__main__':
    ...
    case = NullDataClean(data)
    case.drop_duplicates()
    case.drop_feature_single_unique_value()
    case.drop_column(['tmp_object'])
    case.fillna_with_zero()
    case.fillna_with_mean()
    case.fillna_with_median()
    case.fillna_with_mode()
    case.fillna_with_randomforest()