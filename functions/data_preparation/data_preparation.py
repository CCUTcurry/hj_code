...
class DataLoad:
    ...
    def read_csv(self,file_path,sep,encoding):
        ...
        """        
        data = pd.read_csv(file_path,sep,encoding)
        return data

    def read_excel(self,file_path,sep,encoding):
        """
    ...
    def mysql_load(self,db_config):
        ...
        sql = "SELECT * FROM {}".format(db_config['table_name'])
